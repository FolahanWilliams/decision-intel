            ...
            {preMortem && (
                <div className="mt-8">
                    <h3 className="text-lg font-semibold flex items-center gap-2 mb-4">
                        <ShieldAlert className="h-5 w-5 text-purple-500" style={{ color: 'var(--accent-primary)' }} />
                        ...
                        <div className="card flex flex-col h-full">
                            <div className="card-header pb-2">
                                <h4 className="font-medium flex items-center gap-2">
                                    <AlertTriangle className="h-4 w-4 text-warning" style={{ color: 'var(--warning)' }} />
                                    Potential Failures
                                </h4>
                            </div>
                    ...
                    {/* Pre-Mortem Feedback */}
                    {analysisId && (
                        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between p-4 rounded-lg bg-secondary/20" style={{ background: 'var(--bg-secondary)', borderRadius: 'var(--radius-lg)' }}>
                            <div className="text-sm font-medium mb-3 sm:mb-0" style={{ color: 'var(--text-primary)' }}>
