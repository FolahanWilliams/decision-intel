...
export default function DocumentAnalysisPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="container" style={{ paddingBottom: 'var(--spacing-2xl)' }}>
      ...
      {/* Legacy banner — locked 2026-05-06. This page is the pre-McKinsey-
          refactor view, retained as a fallback for any v1 feature not yet
          ported to the new shell. The main page at /documents/[id] uses
          the new 5-tab + PDF-first layout. */}
