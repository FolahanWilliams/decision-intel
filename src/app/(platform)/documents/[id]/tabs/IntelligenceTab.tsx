    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
      ...
      >
        ...
        <MiniStat
          ...
          value={ctx.researchCount}
          color="#9C27B0"
        />
        <MiniStat
          icon={<Database size={16} />}
          label="Case Studies"
          value={ctx.caseStudyCount}
          color="#4CAF50"
        />
        <MiniStat
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    <ExternalLink
                      size={10}
                      style={{ marginLeft: '4px', opacity: 0.4, display: 'inline' }}
                    />
                  </a>
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: '10px',
                      padding: '2px 6px',
                      background: c.outcome.toLowerCase().includes('fail')
                        ? 'rgba(255,82,82,0.1)'
                        : 'rgba(76,175,80,0.1)',
                      color: c.outcome.toLowerCase().includes('fail')
                        ? 'var(--error)'
                        : 'var(--success)',
                      fontWeight: 600,
                    }}
