...
export default function RiskAuditsPage() {
  ...
  const calculateRiskSummary = (docs: DocumentWithRisk[]): RiskSummary => {
    ...
    docs.forEach(doc => {
      ...
      criticalBiases += analysis.biases.filter(
  ...
  const getRiskLevel = (score: number): { label: string; color: string; bg: string } => {
    ...
    if (score < 70)
      return { label: 'MEDIUM RISK', color: 'var(--warning)', bg: 'rgba(245, 158, 11, 0.1)' };
  ...
  return (
    <div
      ...
      style={{ paddingTop: 'var(--spacing-2xl)', paddingBottom: 'var(--spacing-2xl)' }}
    >
      <Breadcrumbs items={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'Risk Audits' }]} />
      {/* Header */}
      <header className="mb-xl">
        ...
        <p className="text-muted">Comprehensive risk assessment across all analyzed documents</p>
      </header>
          ...
          <div className="grid grid-4 mb-xl gap-md">
            <div className="card animate-fade-in">
              <div className="card-body text-center p-md">
                ...
                <div
                  style={{ fontSize: '2.5rem', fontWeight: 800, color: 'var(--accent-primary)' }}
                >
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderBottom:
                        idx < documents.length - 1 ? '1px solid var(--border-color)' : 'none',
                      display: 'flex',
                      alignItems: 'center',
                      ...
                      <div className="text-center">
                        ...
                        <div className="flex items-center gap-xs">
                          <AlertTriangle
                            size={14}
                            style={{
                              color: biasCount > 0 ? 'var(--warning)' : 'var(--text-muted)',
                            }}
                          />
      ...
      {deleteModal.open && (
        ...
        >
          <div className="card" style={{ maxWidth: 400, width: '90%' }}>
            ...
            <div className="card-body">
              <p className="mb-lg">
                Are you sure you want to delete <strong>{deleteModal.filename}</strong>? This action
                cannot be undone.
              </p>
