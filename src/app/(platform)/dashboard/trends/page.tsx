...
export default function TrendsPage() {
  ...
  const EmptyState = () => (
    ...
    >
      ...
      <p style={{ color: 'var(--text-muted)', fontSize: '13px', maxWidth: '400px' }}>
        Upload and analyze documents to see historical trends. Your decision quality scores, noise
        levels, and bias patterns will appear here over time.
      </p>
    </div>
  );
  ...
  return (
    ...
    >
      <Breadcrumbs
        items={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'Historical Trends' }]}
      />
      {/* Header */}
      <div
        className="flex items-center justify-between mb-xl pb-md"
        style={{ borderBottom: '1px solid var(--border-color)' }}
      >
        <div>
          <h1 style={{ fontSize: '1.5rem', marginBottom: '4px', border: 'none', padding: 0 }}>
            Historical Analysis
          </h1>
              ...
              <div key={i} className="card animate-pulse">
                ...
                <div
                  ...
                  style={{
                    height: 250,
                    background:
                      'repeating-linear-gradient(90deg, rgba(255,255,255,0.04) 0px, rgba(255,255,255,0.04) 8px, transparent 8px, transparent 16px)',
                  }}
                />
              </div>
            ))}
      ...
      {data && data.stats.totalAnalyses > 0 && (
        ...
        >
          <div
            ...
            style={{ background: 'rgba(66, 133, 244, 0.05)' }}
          >
            <div>
                ...
                {marketAnalysis.impactAssessment?.map((impact, i) => (
                  ...
                  >
                    <div className="flex justify-between mb-xs">
                      ...
                      <span
                        className={`badge ${impact.status === 'High' ? 'badge-critical' : 'badge-secondary'}`}
                        style={{ fontSize: '9px' }}
                      >
            ...
            <div className="card mb-xl">
              <div className="card-header flex justify-between">
                <div className="flex items-center gap-md">
                  ...
                  <span
                    className={`badge ${data.stats.trend >= 0 ? 'badge-complete' : 'badge-error'}`}
                  >
                    {data.stats.trend >= 0 ? (
                      <>
          ...
          <div className="grid grid-4 mb-xl gap-md">
            <div className="card">
              <div className="card-body" style={{ textAlign: 'center' }}>
                <div
                  style={{ fontSize: '28px', fontWeight: 'bold', color: 'var(--accent-primary)' }}
                >
                  {data.stats.avgScore}
                </div>
            ...
            <div className="card">
              <div className="card-body" style={{ textAlign: 'center' }}>
                <div
                  style={{ fontSize: '28px', fontWeight: 'bold', color: 'var(--accent-secondary)' }}
                >
                  {data.stats.avgNoise}%
                </div>
                <div style={{ fontSize: '11px', color: 'var(--text-muted)' }}>Avg Noise</div>
              </div>
            </div>
            <div className="card">
              <div className="card-body" style={{ textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '11px', color: 'var(--text-muted)' }}>Total Biases</div>
              </div>
            </div>
            <div className="card">
              <div className="card-body" style={{ textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '11px', color: 'var(--text-muted)' }}>Analyses</div>
              </div>
            </div>
          </div>
