    ...
    <div style={{ padding: 'var(--spacing-xl)', maxWidth: 1200, margin: '0 auto' }}>
        ...
        {tabs.map(tab => (
          <button
            ...
            style={{
              ...
              fontWeight: 500,
              border: '1px solid',
              borderColor: activeTab === tab.key ? 'var(--accent-primary)' : 'var(--glass-border)',
      ...
      {isLoading && (
        <div className="flex items-center justify-center" style={{ padding: 80 }}>
          ...
          <span style={{ marginLeft: 10, color: 'var(--text-muted)', fontSize: 14 }}>Loading rooms...</span>
        </div>
      )}
      ...
      {!isLoading && !error && filteredRooms.length > 0 && (
        <div className="grid grid-2" style={{ gap: 'var(--spacing-md)' }}>
          {filteredRooms.map(room => {
            const typeColors = DECISION_TYPE_COLORS[room.decisionType ?? 'general'] ?? DECISION_TYPE_COLORS.general;
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-md" style={{ marginBottom: 10 }}>
                  {/* Status indicator */}
                  <span className="flex items-center gap-sm" style={{
                    fontSize: 12,
                    fontWeight: 500,
                  ...
                  {/* Participants */}
                  <span className="flex items-center gap-sm" style={{ fontSize: 12, color: 'var(--text-muted)' }}>
                    <Users size={13} />
      ...
      {!isLoading && !error && totalPages > 1 && (
        <div className="flex items-center justify-center gap-md" style={{ marginTop: 'var(--spacing-xl)' }}>
          <button
