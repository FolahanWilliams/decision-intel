        ...
        >
          ...
          <div style={{ display: 'flex', gap: 40, marginTop: 48 }}>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <div style={{ fontSize: 18, color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.8 }}>
...
function Stat({ label, value }: { label: string; value: string }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ fontSize: 48, fontWeight: 700, color: '#ffffff', lineHeight: 1.1 }}>{value}</div>
    </div>
  );
}
