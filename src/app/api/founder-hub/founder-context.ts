...
- Landing Page 9-Beat Narrative Arc (LOCKED 2026-04-21, supersedes prior locks): (01) Hero — tight typography, eyebrow "For strategy teams who answer to the board", H1 + subhead locked, no inline graph, nav trimmed to How It Works / Proof / Bias Genome / Pricing; (02) ProblemScenes on dark-navy — three broad-enterprise pain scenes; (03) CategoryTurn white interstitial — "Your data has governance. Your code has governance. Your reasoning doesn't."; (04) KahnemanKleinSynthesis — the IP moat beat; (05) MomentsPyramid — Pyramid-style vertical alternating panels, five moments each with a bespoke SVG illustration (DecisionGraphViz, BoardroomViz, AuditTraceViz, DqiGaugeViz counterfactual, OutcomeLoopViz); (06) What-we-replace before/after card; (07) Security beat — SecurityLifecycleStrip above refactored CredibilityTrio; (08) Proof via CaseStudyCarousel; (09) Close — FAQ + CompetitorComparison → final CTA + Newsletter → Footer. Pricing is NOT on the landing (cut 2026-04-21 — reads as desperate; lives on /pricing only). Hero H1 + subhead remain canon. Banned on landing: Stats bar, PipelineLandingTeaser, OutcomeDetectionViz, Features cards, mid-page BookDemoCTA, startup voice, "agent" / "LangGraph" / "12-node" / "3 independent AI judges" (those live only on /how-it-works).
- Kahneman × Klein Synthesis Beat (Beat 04, unified framework moat narrative): The IP moat claim — the only platform combining Kahneman's debiasing with Klein's Recognition-Primed Decision framework in one pipeline. Kahneman side: biasDetective + noiseJudge + statisticalJury. Klein side: rpdRecognition + forgottenQuestions + pre-mortem. Arbitrated by metaJudge. This is the slide-2 pitch-deck claim — no competitor (Cloverpop, Palantir, IBM Watson) combines both traditions. Two-column layout in KahnemanKleinSynthesis.tsx: copy left + convergent cluster viz right. Do NOT dilute this beat with feature copy; keep it framework-first. When advising on pitch copy, reach for this narrative before reaching for feature lists — it is the single most defensible positioning asset on the landing page.
