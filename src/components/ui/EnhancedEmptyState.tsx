...
const emptyStateConfigs: Record<EmptyStateType, EmptyStateConfig> = {
  documents: {
    ...
    description: "Start by uploading your first document to analyze for cognitive biases and decision quality.",
    suggestions: [
  ...
  insights: {
    ...
    description: "Upload and analyze documents to see trends, patterns, and bias breakdowns over time.",
    suggestions: [
  ...
  'cognitive-audits': {
    ...
    description: "Submit a document or decision for comprehensive bias analysis and get actionable insights.",
    suggestions: [
  ...
  nudges: {
    ...
    description: "Nudges will appear here when the system detects decision patterns that need attention.",
    suggestions: [
  ...
  compare: {
    ...
    description: "Choose two or more documents to see how their biases and decision quality differ.",
    suggestions: [
  ...
  error: {
    ...
    description: "We couldn't load this content. Please try again or contact support if the issue persists.",
    actions: [
      {
        label: "Retry",
