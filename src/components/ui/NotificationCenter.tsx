...
export function NotificationBell() {
    ...
    const iconForType = (type: NotificationType) => {
        switch (type) {
            case 'analysis_complete': return <CheckCircle size={14} style={{ color: 'var(--success)' }} />;
            case 'low_score': return <AlertTriangle size={14} style={{ color: 'var(--error)' }} />;
            case 'stale_intel': return <Clock size={14} style={{ color: 'var(--warning)' }} />;
            default: return <FileText size={14} style={{ color: 'var(--accent-primary)' }} />;
        }
    };
