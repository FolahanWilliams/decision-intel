      ...
      <div className="card mt-6">
        <div className="card-body text-center p-12">
          ...
          <p className="text-sm text-muted mb-4">
            Analyze documents across different contexts to build your organization&apos;s contextual
            bias profile. The fingerprint reveals how biases vary by document type, deal type, and
            season.
          </p>
