...
export const HONEST_PROBABILITY_PATH: RoadmapPhase[] = [
  {
    id: 'phase-1',
    quarter: 'Q4 2026',
    headline: '8-12 paid Individual £249 customers + Vohra ≥40% HXC PMF signal',
    framing:
      'GTM v3.5 RATIFIED 2026-05-04: prove PMF on the buyer-class-continuous Individual wedge BEFORE Sankore, BEFORE mid-market, BEFORE enterprise. The £249/mo motion is fast, capital-efficient, and produces the case studies that warm-intro to Phase 2. Outcome Gate auto-enforced on HXC users; the Bias Genome data substrate begins accumulating from day one.',
    targets: {
      logos: '8-12 paid Individual £249/mo (15-25 stretch)',
      arr: '~£24-36K (£72K stretch)',
    ...
    whatHasToBeTrue: [
      ...
      '≥2 warm intros to mid-market peers generated from Individual customer network — proves the Phase 2 fuel exists',
      'Sankore engagement contracted at £1,999/mo founding-pilot rate, scheduled for Phase 2 (months 6-12) — NOT activated as a Phase 1 design partner',
      'Mr. Reiner / Mr. Gabe networks NOT yet activated for warm intros — burning them at zero-evidence is the v3.5 single most likely failure mode',
    ],
    conditionalProbability: 0.5,
    primaryRisk:
      'The Continuity Chasm: Phase 1 dilutes the wedge with non-decision-makers (junior analysts, generic mid-market C-suite without M&A budget), MQL-to-SQL collapses to the 15-21% industry baseline, and Phase 2 has no fuel. Mitigation: strict ICP gating in marketing copy + sign-up flow.',
    accent: '#16A34A',
    status: 'now',
  },
  {
    id: 'phase-2',
    quarter: 'Q2-Q4 2027',
    headline: 'Sankore design-partner bridge + first mid-market Strategy customers',
    framing:
    ...
    whatHasToBeTrue: [
      'Sankore signed at £1,999/mo founding-pilot; produces 3+ anonymised reference DPR specimens + 5+ warm intros',
      'Per-organisation Brier-scored calibration loops engineered from Sankore engagement (the moat-accumulation factory, NOT self-serve volume)',
      'Validated team-tier feature set built FROM Sankore + Phase 1 user feedback, NOT speculatively',
      'Mr. Reiner ask activates: 3-5 warm intros to mid-market Heads of Corp Dev at $500M-$2B scale-ups',
      'Mr. Gabe ask activates: 3-5 warm intros to GPs at £100M-£500M AUM funds',
      'EU AI Act Art 14 enforcement (Aug 2026) becomes the Phase 3 procurement-pull instrument, NOT the Phase 1 marketing lead',
      'No premature enterprise escalation — refuse F500 custom PoCs until Phase 3 is fully operational',
    ],
    conditionalProbability: 0.35,
    primaryRisk:
      'Premature Enterprise Escalation: founder activates Mr. Reiner / Mr. Gabe before Phase 1 produces case studies + Sankore reference. Drags solo founder into perpetual custom integrations, stalls product, exhausts $200K runway. Mitigation: lock Phase 3 activation criteria (5+ paid Phase 1 + 3+ ROI + Sankore reference) as non-negotiable.',
    accent: '#D97706',
    status: 'next',
  },
  {
