...
const SECTION_B: Entry[] = [
  {
    ...
    origin: 'Noise: A Flaw in Human Judgment (2021). Insurance underwriter study showed 55% variance where 10% was expected.',
    summary: 'Noise is unwanted variability in judgments that should be identical. Decision hygiene (structured, independent, aggregated judgment) cuts noise without requiring domain expertise.',
  ...
  },
  {
    ...
    origin: 'Sources of Power (1998). Research on firefighters, nurses, and NICU clinicians showed experts pattern-match, they do not enumerate options.',
    summary: 'Experts recognize situations from prior experience and mentally simulate how the chosen course will play out. Pre-mortem and narrative simulation are standard RPD tools.',
  ...
  },
  {
    ...
    summary: 'Fast, automatic System 1 judgment is easily hijacked by anchoring, availability, representativeness, loss aversion, and confirmation. System 2 is capable of correction but lazy.',
  ...
  },
  {
    ...
    summary: 'Hybrid human-machine forecasters beat both pure AI and pure humans. Calibration is trainable. Brier scores measure how well stated probabilities match outcomes.',
  ...
  },
  {
    ...
    summary: 'Distinguishes decision quality from outcome quality (resulting bias). Pre-commitment and decision architecture beat willpower for debiasing.',
  ...
  },
  {
    ...
    summary: 'Rational belief update combines a prior with likelihood of new evidence. Blind priors captured before new evidence arrives create a clean audit trail for belief change.',
...
const SECTION_C: Entry[] = [
  {
    ...
    summary: 'Imagine the decision has failed catastrophically a year from now. Write the story of why. Surfaces concerns that direct optimism suppresses.',
  ...
  },
  {
    ...
    summary: 'Solve the problem backward. Instead of asking how to succeed, ask what guarantees failure, then avoid those paths.',
  ...
  },
  {
    ...
    summary: 'If nine people agree, the tenth must argue the contrarian position no matter how implausible. Institutionalised dissent.',
  ...
  },
  {
    ...
    summary: 'Lock yourself into a future action while your judgment is clear so your later, biased self cannot defect. Odysseus tying himself to the mast.',
  ...
  },
  {
    ...
    summary: '"And then what?" Chain out the consequences of the consequences. First-order thinking stops at the obvious move.',
  ...
  },
  {
    ...
    summary: 'Observe, Orient, Decide, Act. Decision tempo under uncertainty. Whoever cycles faster with correct orientation wins.',
  ...
  },
  {
    ...
    summary: 'Classifies a situation as simple, complicated, complex, or chaotic. Each class demands a different decision approach.',
  ...
  },
  {
    ...
    summary: 'Four conditions (diversity, independence, decentralisation, aggregation) make group judgment outperform any individual expert. Violate any condition and the crowd becomes a mob.',
  ...
  },
  {
    ...
    summary: 'Classify decisions as reversible (two-way doors, move fast) versus irreversible (one-way doors, deliberate carefully). Most decisions are two-way but teams treat them as one-way.',
  ...
  },
  {
    ...
    summary: 'Six-element chain: appropriate frame, creative alternatives, meaningful information, clear values, logical reasoning, commitment to action. A decision is only as strong as its weakest link.',
...
const SECTION_D: Entry[] = [
  {
    ...
    summary: 'Labelling, mirroring, calibrated questions, and accusation audits lower the other side\u2019s defences so they can hear you. Emotion first, logic second.',
  ...
  },
  {
    ...
    summary: 'Lead with the conclusion. Support it with two to three arguments. Detail each argument. Mirrors how busy executives consume information.',
  ...
  },
  {
    ...
    summary: 'The customer is the hero, not the brand. The brand is the guide. Seven-part framework (character, problem, guide, plan, call to action, success, failure).',
  ...
  },
  {
    ...
    origin: 'Hooked (2014).',
    summary: 'Trigger then action then variable reward then investment. Builds habit loops that survive without ongoing motivation.',
...
const SECTION_E: Entry[] = [
  {
    ...
    summary: 'Customers hire products to do a job in their life. The job is stable even as demographics, technologies, and competitors change. Focus on the job, not the customer.',
  ...
  },
  {
    ...
    summary: 'Early markets (innovators, early adopters) require radically different go-to-market motions than mainstream markets (early majority). Most startups die in the chasm between them.',
  ...
  },
  {
    ...
    summary: 'Compete in uncontested market space by simultaneously pursuing differentiation and low cost. The Value Curve plots competing offerings across buyer attributes.',
  ...
  },
  {
    ...
    summary: 'The kernel of strategy is diagnosis, guiding policy, and coherent actions. Most "strategy" is actually wishful goals with no diagnosis.',
  ...
  },
  {
    ...
    summary: 'Map customer jobs, pains, and gains to products, pain relievers, and gain creators. Forces explicit fit between offer and customer.',
  ...
  },
  {
    ...
    summary: 'Customer interviews should talk about the prospect\u2019s life and problems, not about your idea. Even your mom cannot lie about specific past behaviours.',
  ...
  },
  {
    ...
    summary: 'Perceived value equals (dream outcome times perceived likelihood of achievement) divided by (time delay times effort and sacrifice). Maximise the numerator, minimise the denominator.',
  ...
  },
  {
    ...
    summary: 'Frame it, name it, claim it. Category kings take 76% of category economics. Winning a category beats winning a product competition.',
...
const SECTION_F: Entry[] = [
  {
    ...
    summary: 'Seven and only seven sources of durable competitive advantage: Scale Economies, Network Economies, Counter-Positioning, Switching Costs, Branding, Cornered Resource, Process Power. Anything else is table stakes.',
  ...
  },
  {
    ...
    summary: 'Contrarian truth: what important truth do very few people agree with you on? Monopoly is the goal, competition is for losers. Last-mover advantage in a new category.',
  ...
  },
  {
    ...
    summary: 'Nine principles of VC decision making. Consensus-seeking committees have LOWER success rates. Home runs drive returns, not averages. Reframe the pitch from defensive (avoid mistakes) to offensive (swing with confidence).',
  ...
  },
  {
    ...
    summary: 'Industry profitability is determined by supplier power, buyer power, threat of substitutes, threat of new entrants, and rivalry among existing competitors.',
  ...
  },
  {
    ...
    summary: 'In the internet era, value accrues to whoever aggregates demand (users), not whoever controls supply. The moat is the user relationship plus data network effects, not the underlying technology.',
  ...
  return (
    <div>
      <div style={{ ...card, borderTop: '3px solid #16A34A' }}>
        ...
        <div style={bodyText}>
          The intellectual foundation of Decision Intel. Every entry below lists the framework,
          its origin, a one-paragraph summary, why it matters for this product, and the specific
          file or component where it lives (or Roadmap if not yet shipped). Use this page as both
          a reference for sales conversations and a backlog of intellectual integrations to ship.
        </div>
      </div>
