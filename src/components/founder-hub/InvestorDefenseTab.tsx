...
const QA_ITEMS: Array<{ q: string; a: string; proof?: string }> = [
  ...
  },
  {
    ...
    a: "API cost per analysis: $0.03-0.07 using Gemini Flash. Corp Dev plan: $2,499/month. That's ~97% gross margin. The motion: land with a per-deal audit ($4,999 one-time, expensed on the deal — no procurement cycle), prove ROI with outcome data, convert to Corp Dev subscription ($2,499/mo), then negotiate enterprise ($50K–$200K/yr ACV). Outcome tracking creates natural switching costs — historical calibration profiles and decision knowledge graphs become org-specific assets that can't transfer to a competitor.",
  },
  {
...
const OBJECTIONS: Array<{ objection: string; response: string }> = [
  ...
  },
  {
    ...
    response:
      "We don't replace consulting — we make their most expensive service 1,000x cheaper and always-on. McKinsey charges $500K-$2M per strategic review, takes 6-12 weeks, and their consultants carry their own cognitive biases into the analysis. We deliver the same core service — decision quality assessment — in 60 seconds, continuously, for $2,499/month or $4,999 per deal.",
  },
  {
