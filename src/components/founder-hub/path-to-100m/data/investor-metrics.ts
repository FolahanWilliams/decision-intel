...
export const INVESTOR_METRICS: InvestorMetric[] = [
  ...
  },
  {
    ...
    diCurrent:
      '10 of 10 ranked applications shipped — sprint COMPLETE 2026-05-07: #2 Validity Classifier (Kahneman & Klein 2009 first condition · DQI methodology v2.1.0 with structural weight shift) · #6 Feedback Adequacy (2009 second condition) · #8 Reference Class Forecast (Kahneman & Lovallo 2003 HBR) · #3 Illusion of Validity DI-B-021 (2009 central finding) · #9 Inside-View Dominance DI-B-022 (Lovallo 2003) · #5 Prospective Hindsight pre-mortem (Klein & Mitchell 1995) · #10 Calibrated Rejection of Subjective Confidence (2009 paper full conclusion · Item 3 of wedge-batch-3 lock 2026-05-07) · #1 Fractionation of Expertise (2009 sub-domain finding · wedge-batch-4 2026-05-07) · #4 Improper Linear Models / Decision Rubric (Dawes 1979 · wedge-batch-4 2026-05-07) · #7 Algorithm Aversion (Dietvorst, Simmons & Massey 2015 · wedge-batch-4 2026-05-07). Five distinct DOI-citable anchors. 22-bias stable taxonomy (DI-B-001 through DI-B-022). Live atlas at /r2f-standard.',
    diTarget12mo:
      'Sprint complete. Next phase: extend 9 DPR strips → live-pipeline persistence so per-org Brier supersedes the seed baseline. Build the Decision Framing Gate (R²F moat-lever rank 3) as the next paper-grounded surface. Ship Mercier & Sperber argumentative-debate multi-agent pipeline (R²F moat-lever rank 1) for Q3 2026.',
    whyItMatters:
      'R²F is now FULLY operationalised — every claim in the marketing copy has a corresponding line of code, an academic anchor with DOI, and a procurement-grade surface a Fortune 500 GC can cite. Investor narrative: "the framework is the academic literature, applied as code, on every audit." Five anchors across five papers (Kahneman & Klein 2009, Lovallo 2003 HBR, Klein & Mitchell 1995, Dawes 1979, Dietvorst 2015) is structurally harder for an incumbent to clone than 10 marketing claims.',
    computeMethod:
