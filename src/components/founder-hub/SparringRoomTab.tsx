  ...
  return (
    ...
    >
      ...
      >
        ...
        paste the transcript back. The AI grades you on {GRADING_DIMENSIONS.length} dimensions —
        Maalouf 4 + Satyam 3 + DI discipline 2 + <strong>Kahneman loss-aversion framing</strong> +
        fundamentals + 4 meta-dimensions (JOLT/Sandler/Cohen) — simulates the buyer&rsquo;s internal
        monologue right after you finish, and hands you the verbatim phrase you should have used so
        you can rehearse it before the next call.
      </p>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 13, color: 'var(--text-secondary)' }}>
        Running {GRADING_DIMENSIONS.length}-dimension Sales DQI · simulating the buyer&rsquo;s
        internal monologue · drafting the verbatim phrase you should have used.
      </div>
    </div>
  );
}
