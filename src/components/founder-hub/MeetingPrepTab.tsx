  ...
  return (
    <div style={{ maxWidth: 800 }}>
      ...
      >
        ...
        <p style={{ fontSize: '0.8rem', color: S.slate400, margin: 0, lineHeight: 1.5 }}>
          ...
          <span style={{ color: S.green }}>
            How you got here: Cold LinkedIn outreach → she replied. That&apos;s already a signal.
          </span>
        </p>
        <div
          style={{
        ...
        >
          <li>
            ...
            <strong style={{ color: 'var(--text-primary)' }}>
              She is not a GP — she does not write the cheques.
            </strong>{' '}
            Her job is to find and develop great founders, then connect the best ones to the
            investment team.
          </li>
          <li>
            <strong style={{ color: 'var(--text-primary)' }}>
              The goal isn&apos;t to close investment.
            </strong>{' '}
          ...
          <li>
            ...
            <strong style={{ color: 'var(--text-primary)' }}>
              She&apos;ll immediately understand the buyer persona — she&apos;s lived inside one.
            </strong>
          </li>
        </ul>
      </div>
      ...
      <div style={sectionCard(S.purple)}>
        ...
        >
          ...
          <li>
            ...
            <strong style={{ color: 'var(--text-primary)' }}>strong end</strong> of their range —
            you have a functioning 190K LOC platform, not just a pitch.
          </li>
          <li>
          ...
          <li>
            ...
            infrastructure.{' '}
            <strong style={{ color: 'var(--text-primary)' }}>
              Decision Intel fits that pattern cleanly.
            </strong>
          </li>
        </ul>
      </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          <div>
            ...
            <div style={{ ...scriptLine, borderLeft: `3px solid ${S.amber}` }}>
              ...
              data — the data is usually fine. Because of bad reasoning. Anchoring bias,
              confirmation bias, groupthink — these are predictable, well-documented cognitive
              errors. And nobody audits for them. Every memo gets a financial review, a legal
              review, a compliance review. Nobody reviews the quality of the thinking itself.&rdquo;
            </div>
          </div>
          <div>
      ...
      <div style={sectionCard(S.purple)}>
        ...
        >
          <li>
            <strong style={{ color: 'var(--text-primary)' }}>Open — Make it personal</strong> (2
            min)
            <br />
            Thank her genuinely for replying. Ask one question about her before pitching:{' '}
            <em>
              &ldquo;You work across Japan and global programs — how do you think about where the
              most interesting founders are coming from right now?&rdquo;
            </em>{' '}
            Shows you&apos;re curious about her perspective, not just there to pitch.
          </li>
          <li>
            <strong style={{ color: 'var(--text-primary)' }}>
              The problem — Lead with this, not the product
            </strong>{' '}
            (2–3 min)
            <br />
          ...
          <li>
            <strong style={{ color: 'var(--text-primary)' }}>
              Your founder story — This is your edge
            </strong>{' '}
            (1–2 min)
            <br />
            ...
            <strong style={{ color: S.amber }}>
              Don&apos;t rush this. Antler invests in founders first, products second.
            </strong>
          </li>
          <li>
            ...
            Don&apos;t read the slides — talk through them. Pause on the product slides for the live
            demo: upload sample memo → pipeline graph (wow moment) → DQI score reveal → 2–3 biases
            with excerpts → <strong>Forgotten Questions</strong> tab → Boardroom Simulation.
          </li>
          <li>
          ...
          <li>
            <strong style={{ color: 'var(--text-primary)' }}>Her questions — Listen hard</strong>{' '}
            (5–10 min)
            <br />
      ...
      <div style={sectionCard(S.blue)}>
        ...
        <div>
          {[
            ...
            <div
              key={i}
              style={{ ...qaRow, borderBottom: i < 3 ? '1px solid var(--border-color)' : 'none' }}
            >
      ...
      >
        ...
        <p style={{ ...body, marginTop: 10, fontSize: '0.78rem', color: 'var(--text-muted)' }}>
          That&apos;s two questions in one: get her read on fit, and request the warm intro in the
          same breath.
        </p>
      </div>
