...
export const INVESTOR_QA: InvestorQA[] = [
  ...
  },
  {
    ...
    answer:
      "We are applying Peter Thiel's monopoly framework: dominate a high-stakes, high-WTP vertical before expanding horizontally. The vertical is broader than it looks — corporate strategy + corporate development + funds (PE, EM-focused VC, family offices) + audit committees + GCs at regulated entities. Cloverpop's generic AI is fine for deciding where to host a corporate retreat; a generic LLM cannot audit a $500M acquisition memo. Our R²F engine has the DI-B taxonomy (currently 22 stable IDs through DI-B-022, extending with the Kahneman-Klein paper-application sprint) with strategy-specific overlays — Winner's Curse, Valuation Anchoring, Synergy Overconfidence — and the 19-framework regulatory map across G7, EU, GCC, and African markets means a Pan-African GC reading our security posture sees NDPR, CBN, WAEMU, ISA Nigeria 2007 mapped alongside Basel III and EU AI Act. That's not nice-to-have; that's must-have regulatory CYA. The Pan-African angle alone (which no US incumbent has) opens a beachhead worth $50-150B+ in corporate strategy spend that's structurally underserved.",
    proof:
      'src/lib/compliance/frameworks/ — getAllRegisteredFrameworks().length regulatory framework implementations including EU AI Act Art 14, SOC 2 Type II, GDPR Art 22, Basel III Pillar 2, SOX §404, NDPR, CBN, WAEMU, ISA Nigeria 2007, PoPIA §71, CMA Kenya, SARB Model Risk, and more',
  },
  {
    id: 'solo_founder',
    topic: 'team',
