...
export const INDUSTRY_SUCCESS_CASES: CaseStudy[] = [
  {
    ...
    impactScore: 94,
    estimatedImpact:
      '$30B+ cumulative box office; $4B acquisition by Disney; created the franchise universe model',
    impactDirection: 'positive',
    biasesPresent: ['planning_fallacy', 'overconfidence_bias', 'anchoring_bias'],
  ...
  },
  {
    ...
    impactDirection: 'positive',
    biasesPresent: ['overconfidence_bias', 'planning_fallacy', 'anchoring_bias'],
  ...
  },
  {
    ...
    impactDirection: 'positive',
    biasesPresent: ['loss_aversion', 'status_quo_bias', 'confirmation_bias'],
  ...
  },
  {
    ...
    impactScore: 89,
    estimatedImpact:
      "Revenue grew from $1.1B (2004) to $5.8B (2019); became world's largest toy company",
    impactDirection: 'positive',
    biasesPresent: ['sunk_cost_fallacy', 'status_quo_bias', 'anchoring_bias', 'loss_aversion'],
  ...
  },
  {
    ...
    impactScore: 86,
    estimatedImpact:
      '$50B+ market cap; saved the recorded music industry from irreversible piracy-driven decline',
    impactDirection: 'positive',
    biasesPresent: ['anchoring_bias', 'loss_aversion', 'status_quo_bias'],
  ...
  },
  {
    ...
    impactScore: 82,
    estimatedImpact:
      'Revenue grew from $33B (2000) to $67B (2010); Kmart bankrupted pursuing price-only strategy',
    impactDirection: 'positive',
    biasesPresent: ['status_quo_bias', 'anchoring_bias', 'confirmation_bias'],
