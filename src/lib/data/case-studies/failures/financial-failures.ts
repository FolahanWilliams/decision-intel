...
export const FINANCIAL_FAILURE_CASES: CaseStudy[] = [
  {
    ...
    toxicCombinations: ['Echo Chamber', 'Sunk Ship', 'Synergy Mirage', 'Conglomerate Fallacy'],
    beneficialPatterns: [],
    biasesManaged: [],
    mitigationFactors: [],
  ...
  },
  {
    ...
    toxicCombinations: ['Sunk Ship', 'Optimism Trap', 'Status Quo Lock', 'Conglomerate Fallacy'],
    beneficialPatterns: [],
    biasesManaged: [],
    mitigationFactors: [],
    survivorshipBiasRisk: 'low',
