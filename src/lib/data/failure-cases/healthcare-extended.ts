...
export const HEALTHCARE_EXTENDED_CASES: FailureCase[] = [
  {
    ...
    source:
      'FDA Class II Recall of DePuy ASR Hip System (2010); BMJ Investigation by Deborah Cohen (2011)',
  ...
  },
  {
    ...
    source:
      'Barter et al., "Effects of Torcetrapib in Patients at High Risk for Coronary Events," NEJM (2007)',
  ...
  },
  {
    ...
    source:
      'DOJ Press Release, "Founder and Four Executives of Insys Therapeutics Convicted of RICO Conspiracy" (2019)',
  ...
  },
  {
    ...
    source:
      'Michigan Civil Rights Commission, "The Flint Water Crisis: Systemic Racism Through the Lens of Flint" (2017); Flint Water Advisory Task Force Report (2016)',
    sourceType: 'post_mortem',
  },
  {
    id: 'health-ext-007',
    ...
    impactScore: 70,
    estimatedLoss:
      '$11B market cap loss when CMS restricted coverage; institutional credibility damage',
    biasesPresent: [
      'authority_bias',
      'confirmation_bias',
      'optimism_bias',
    ...
    source:
      'FDA Peripheral and Central Nervous System Drugs Advisory Committee meeting transcript (2020); STAT News investigation (2021)',
    sourceType: 'fda_action',
  },
];
