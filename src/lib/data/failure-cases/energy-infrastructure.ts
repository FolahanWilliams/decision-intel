...
export const ENERGY_INFRASTRUCTURE_CASES: FailureCase[] = [
  {
    ...
    source:
      'National Diet of Japan Fukushima Nuclear Accident Independent Investigation Commission (NAIIC) Report (2012)',
  ...
  },
  {
    ...
    source:
      'FERC/NERC Joint Report on February 2021 Cold Weather Grid Operations (2021); Texas House Committee Investigation',
    sourceType: 'post_mortem',
  },
  {
    id: 'energy-ext-003',
    ...
    source:
      'NTSB Marine Accident Report MAR-90-04 (1990); Alaska Oil Spill Commission Final Report (1990)',
  ...
  },
  {
    ...
    source:
      'Brazilian Federal Police investigation report (2020); Brazilian Senate CPI inquiry (2019)',
    sourceType: 'post_mortem',
  },
  {
    id: 'energy-ext-005',
  ...
  },
  {
    ...
    source:
      'South Carolina House Legislative Oversight Committee investigation (2018); Westinghouse bankruptcy filing (2017)',
  ...
  },
  {
    ...
    source:
      "Governor's Independent Investigation Panel Report (2011); MSHA investigation report (2011); DOJ indictment of Don Blankenship",
    sourceType: 'post_mortem',
  },
];
