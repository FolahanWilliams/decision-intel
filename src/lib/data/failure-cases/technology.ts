...
export const TECHNOLOGY_CASES: FailureCase[] = [
  ...
  },
  {
    ...
    impactScore: 9.5,
    estimatedLoss: '$243B',
    biasesPresent: ['status_quo_bias', 'overconfidence_bias', 'groupthink'],
    primaryBias: 'status_quo_bias',
  ...
  },
  {
    ...
    impactScore: 8.5,
    estimatedLoss: '$6B',
    biasesPresent: ['anchoring_bias', 'status_quo_bias', 'overconfidence_bias'],
  ...
  },
  {
    ...
    impactScore: 8.5,
    estimatedLoss: '$9B',
    biasesPresent: ['authority_bias', 'groupthink', 'confirmation_bias'],
  ...
  },
  {
    ...
    impactScore: 8.0,
    estimatedLoss: '$39B',
    biasesPresent: ['overconfidence_bias', 'authority_bias', 'groupthink'],
  ...
  },
  {
    ...
    impactScore: 5.5,
    estimatedLoss: '$500M+',
    biasesPresent: ['confirmation_bias', 'overconfidence_bias', 'bandwagon_effect'],
  ...
  },
  {
    ...
    impactScore: 7.0,
    estimatedLoss: '$5B',
    biasesPresent: ['overconfidence_bias', 'planning_fallacy', 'confirmation_bias'],
    primaryBias: 'overconfidence_bias',
    toxicCombinations: [],
    contextFactors: {
      monetaryStakes: 'very_high',
