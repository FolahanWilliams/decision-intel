...
export const FINANCIAL_SERVICES_CASES: FailureCase[] = [
  ...
  },
  {
    ...
    impactScore: 8.5,
    estimatedLoss: '$1.6B',
    biasesPresent: ['anchoring_bias', 'overconfidence_bias'],
  ...
  },
  {
    ...
    impactScore: 9.0,
    estimatedLoss: '$1.3B',
    biasesPresent: ['authority_bias', 'overconfidence_bias'],
  ...
  },
  {
    ...
    impactScore: 9.5,
    estimatedLoss: '$4.6B',
    biasesPresent: ['overconfidence_bias', 'anchoring_bias', 'cognitive_misering'],
    primaryBias: 'overconfidence_bias',
    toxicCombinations: [],
    contextFactors: {
      monetaryStakes: 'very_high',
  ...
  },
  {
    ...
    impactScore: 9.5,
    estimatedLoss: '$74B',
    biasesPresent: ['groupthink', 'confirmation_bias', 'authority_bias'],
    primaryBias: 'groupthink',
  ...
  },
  {
    ...
    impactScore: 10,
    estimatedLoss: '$182B',
    biasesPresent: ['overconfidence_bias', 'anchoring_bias'],
    primaryBias: 'overconfidence_bias',
    toxicCombinations: [],
    contextFactors: {
      monetaryStakes: 'very_high',
  ...
  },
  {
    ...
    impactScore: 8.5,
    estimatedLoss: '€1.9B',
    biasesPresent: ['confirmation_bias', 'authority_bias', 'groupthink'],
  ...
  },
  {
    ...
    impactScore: 7.5,
    estimatedLoss: '$5.5B',
    biasesPresent: ['anchoring_bias', 'status_quo_bias', 'cognitive_misering'],
    primaryBias: 'anchoring_bias',
    toxicCombinations: [],
    contextFactors: {
      monetaryStakes: 'very_high',
  ...
  },
  {
    ...
    impactScore: 9.0,
    estimatedLoss: '$32B',
    biasesPresent: ['authority_bias', 'groupthink', 'overconfidence_bias'],
    primaryBias: 'authority_bias',
    toxicCombinations: ['Yes Committee'],
    contextFactors: {
      monetaryStakes: 'very_high',
  ...
  },
  {
    ...
    impactScore: 7.5,
    estimatedLoss: '$1.6B',
    biasesPresent: ['overconfidence_bias', 'anchoring_bias', 'authority_bias'],
    primaryBias: 'overconfidence_bias',
    toxicCombinations: [],
    contextFactors: {
      monetaryStakes: 'very_high',
  ...
  },
  {
    ...
    impactScore: 6.5,
    estimatedLoss: '$630M',
    biasesPresent: ['status_quo_bias', 'cognitive_misering', 'groupthink'],
  ...
  },
  {
    ...
    impactScore: 9.5,
    estimatedLoss: '$64.8B',
    biasesPresent: ['authority_bias', 'confirmation_bias', 'bandwagon_effect'],
    primaryBias: 'authority_bias',
    toxicCombinations: ['Echo Chamber'],
    contextFactors: {
      monetaryStakes: 'very_high',
