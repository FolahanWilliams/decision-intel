...
export const HEALTHCARE_CASES: FailureCase[] = [
  {
    ...
    impactScore: 9.0,
    estimatedLoss: '$4.85B',
    biasesPresent: ['confirmation_bias', 'selective_perception', 'groupthink'],
    ...
    source: 'Merck SEC filings; Bombardier et al., "Comparison of Upper Gastrointestinal Toxicity of Rofecoxib and Naproxen," NEJM (2000)',
  ...
  },
  {
    ...
    impactScore: 10,
    estimatedLoss: '$8.3B',
    biasesPresent: ['confirmation_bias', 'loss_aversion', 'groupthink'],
    primaryBias: 'confirmation_bias',
    toxicCombinations: [],
    contextFactors: {
      monetaryStakes: 'very_high',
  ...
  },
  {
    ...
    impactScore: 7.5,
    estimatedLoss: '$3.9B',
    biasesPresent: ['status_quo_bias', 'confirmation_bias', 'loss_aversion'],
  ...
  },
  {
    ...
    impactScore: 10,
    estimatedLoss: '$20B',
    biasesPresent: ['overconfidence_bias', 'sunk_cost_fallacy', 'authority_bias'],
    primaryBias: 'sunk_cost_fallacy',
    toxicCombinations: ['Sunk Ship'],
    contextFactors: {
      monetaryStakes: 'very_high',
      dissentAbsent: true,
      timePressure: true,
  ...
  },
  {
    ...
    biasesPresent: ['status_quo_bias', 'groupthink', 'cognitive_misering'],
    primaryBias: 'status_quo_bias',
    toxicCombinations: [],
    contextFactors: {
      monetaryStakes: 'low',
  ...
  },
  {
    ...
    biasesPresent: ['authority_bias', 'confirmation_bias', 'groupthink'],
    ...
    source: 'CMS Inspection Report of Theranos Newark Lab (2016); John Carreyrou, "Bad Blood" (2018)',
    sourceType: 'fda_action',
  },
];
...
export const ENERGY_INDUSTRIAL_CASES: FailureCase[] = [
  {
    ...
    impactScore: 10,
    estimatedLoss: '$65B',
    biasesPresent: ['overconfidence_bias', 'sunk_cost_fallacy', 'cognitive_misering'],
    primaryBias: 'overconfidence_bias',
    toxicCombinations: ['Blind Sprint'],
    contextFactors: {
      monetaryStakes: 'very_high',
      dissentAbsent: false,
      timePressure: true,
  ...
  },
  {
    ...
    impactScore: 9.5,
    estimatedLoss: '$33B',
    biasesPresent: ['groupthink', 'authority_bias', 'sunk_cost_fallacy'],
  ...
  },
  {
    ...
    impactScore: 8.5,
    estimatedLoss: '$22B',
    biasesPresent: ['anchoring_bias', 'overconfidence_bias', 'sunk_cost_fallacy'],
  ...
  },
  {
    ...
    impactScore: 10,
    estimatedLoss: '$13.5B',
    biasesPresent: ['status_quo_bias', 'cognitive_misering', 'loss_aversion'],
    primaryBias: 'status_quo_bias',
    toxicCombinations: [],
    contextFactors: {
      monetaryStakes: 'very_high',
  ...
  },
  {
    ...
    impactScore: 6.0,
    estimatedLoss: '$535M',
    biasesPresent: ['overconfidence_bias', 'confirmation_bias', 'planning_fallacy'],
    primaryBias: 'overconfidence_bias',
    toxicCombinations: [],
    contextFactors: {
      monetaryStakes: 'high',
  ...
  },
  {
    ...
    biasesPresent: ['groupthink', 'authority_bias', 'availability_heuristic'],
    primaryBias: 'groupthink',
    toxicCombinations: ['Yes Committee'],
    contextFactors: {
      monetaryStakes: 'very_high',
    ...
    source: 'Presidential Commission on the Space Shuttle Challenger Accident (Rogers Commission Report, 1986)',
    sourceType: 'case_study',
  },
  {
    id: 'energy-007',
    ...
    biasesPresent: ['groupthink', 'status_quo_bias', 'anchoring_bias'],
    primaryBias: 'groupthink',
    ...
    source: 'Columbia Accident Investigation Board Report (2003)',
    sourceType: 'case_study',
  },
];
