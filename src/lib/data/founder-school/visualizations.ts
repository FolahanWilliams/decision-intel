...
const VIZ_PLATFORM_FOUNDATIONS: Record<string, LessonViz> = {
  ...
  pf_7: {
    ...
    steps: [
      ...
      { label: 'Compliance mapper', detail: 'Cross-links 7 frameworks.' },
  ...
  pf_8: {
    ...
    nodes: [
      ...
      { label: 'EU AI Act', emphasis: true, detail: 'Rising gate on any AI-involved decision.' },
      { label: 'NIST AI RMF', detail: 'US federal standard. Govern / Map / Measure / Manage.' },
    ],
  },
  pf_9: {
    type: 'pyramid',
