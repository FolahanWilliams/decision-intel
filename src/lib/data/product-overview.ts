...
export const ROI_NARRATIVE = {
  headline: 'ROI',
  body: 'A single avoided bad decision saves organizations **millions to billions** in value. The platform pays for itself after one corrected thesis. Organizations running structured pre-decision audits report **up to 60% reduction** in decision variance.',
  pricingAnchor:
