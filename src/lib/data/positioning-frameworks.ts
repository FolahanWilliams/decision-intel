...
export const BRAND_STEPS: BrandStep[] = [
  ...
  },
  {
    ...
    diAnswer:
      'Tagline: "Decision Intel is the reasoning audit platform." Contrast: "Most tools audit your data. We audit your reasoning." First-line outreach: "Kodak lost $31B. We would have caught it." All instantly legible.',
    status: 'partial',
