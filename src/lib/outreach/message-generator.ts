...
Who it's for (Phase 1 wedge — months 1-6, NOW, v3.5 ratified 2026-05-04): the FOUR buyer-class-continuous personas at £249/mo Individual tier — (a) Fractional CSOs running 3-5 client engagements with regular memo flow, (b) Heads of Corp Dev / M&A at $50M-$500M revenue scale-ups with personal-decisive budget, (c) GPs / principals at smaller funds (£5M-£100M AUM) with active deal flow OR LP-governance pressure, (d) PE-backed founders / CEOs owning the strategic memo workflow. UK + US. Junior analysts and roles outside these four are NOT the marketed Phase 1 cohort — but access is never gated: non-wedge sign-ups get full platform access with the generic overview and are cohort-tagged out of the Vohra HXC measurement (access-policy amendment 2026-05-19; access ≠ cohort). NEVER tell a prospect they would be waitlisted.
