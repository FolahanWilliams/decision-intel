...
4.  **Handoff**:
    ...
    - _Note_: The `fact_checker` may need the original text _only_ if verifying specific public claims, but internal PII must remain masked.

## Usage Rule

- **Mandatory Step**: This skill must be applied _immediately_ after Ingestion and _before_ any Multi-Agent Analysis.
