...
- [x] **15 daily-fill actions across 5 review clusters** (expanded 2026-06-07 from 8): Goals & day (daily_goal · complete_goal · period_goal · daily_reflection) · Work (meeting_log · todo_add · todo_complete) · Outreach (prospect_create · prospect_advance) · Faith OS (faith_checkin · prayer_journal · reading_progress) · Learning (sat_session · sat_test · content_log). No schema change; no new audio infra (Wispr-paste is the voice path).
