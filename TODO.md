...
- [x] 8 daily-fill actions: daily_goal · complete_goal · daily_reflection · faith_checkin · sat_session · meeting_log · prospect_create · prospect_advance. No schema change; no new audio infra (Wispr-paste is the voice path).
- [x] Gates: tsc clean · 15/15 intake vitest · 5 lints (silent-catches 231→235, documented) · prettier · slop-scan.
