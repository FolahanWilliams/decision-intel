# Advisor Call — Roy Eitan (GTM / Scaling) — 2026-05-16

> **Status:** Working summary, founder-private. Compiled 2026-05-18 from contemporaneous memory records of the call (not a verbatim transcript). Where a point is the founder's stated plan vs. Roy's actual words vs. post-call synthesis, it is flagged inline.
> **Format:** Free intro call (~2026-05-16). Roy reached via the founder's own cold LinkedIn outreach — the same 1-1-1 traffic-source motion the GTM plan runs on.
> **Participants:** Folahan (founder) · Roy Eitan (GTM/scaling advisor).

---

## 1. Who Roy Eitan is

Startup advisor based in Palo Alto, CA. Advises early-stage (Seed → Series A) B2B tech founders on go-to-market: positioning, early customer acquisition, repeatable GTM, the operational foundation for global scale, fundraising readiness, and GTM hiring.

- **Operating background:** Ex-COO of Augury (oversaw Service / CS / Manufacturing / Supply Chain / IT / PMO / Enablement). ~2 decades scaling software + hardware across US / Israel / Canada / Singapore / APAC / Europe. Kellogg / Northwestern.
- **Reach + connector value:** ~10K LinkedIn followers. Self-described natural connector — facilitates warm intros to VCs, enterprise buyers, strategic partners, and senior operators. More than 50% of the founders he has supported raised a round in the past year.
- **On-ramp:** His public Calendly "Book an Intro Call" is how the first (free) call was booked.

**Where to weight his input:** Roy is a **GTM-depth / scaling / distribution / fundraise-readiness** advisor, not a decision-science domain advisor. Weight him heavily on scaling, distribution, positioning, and warm-intro paths into US/global VCs and enterprise buyers; weight him **less** on the R²F IP itself.
...
## 2. How the meeting came about

The founder cold-messaged Roy on LinkedIn (the same outbound discipline used for prospect outreach). Roy responded and took a free intro call. He was explicit that he is **open to a continued relationship** — a paid or ongoing advisory engagement is the implied next stage, but **not now**; the intro call was the relationship-opening move, not a commitment.

---

## 3. The core challenge — the "is it just a wrapper / what's your moat?" pushback

This was the substance of the call and the reason it was worth capturing.
...
## 4. The convergence signal (multiple advisors saying the same thing)
...
## 5. The answer developed (the "is it just a wrapper?" response)
...
## 6. The false-binary dissolution (the most useful reframe)
...
## 7. The validated near-term wedge

Roy explicitly endorsed the summer path:

- Go **DEEP into 1–2 real companies** (via potential summer internships), get the product integrated, gather real critical customer feedback, make it **indispensable**, and potentially get hired-in / acquired-in.
- He framed this as a legitimately great outcome that **"scales to a couple hundred thousand ARR easily"** — distinct from the harder $100M+ ceiling, which requires the full IP-moat + brand + distribution build.
- This generalises the existing Phase-2 bridge motion: deep integration into a reference customer that produces the case study unlocking the next phase.

---

## 8. The summer SMART goal + the 2-question discovery framework

**SMART goal the founder set on the call (target ~end of summer / July):**

> **≥5 users with a clear, measurable ROI → a case study that quantifies what the product saved them.**

**Discovery method** (the founder's, from a video on a founder who scaled to $3.5B) — a 2-question framework to run with each early user:

1. **What is the biggest pain point in their workflow?**
2. **What one integration would make this an indispensable tool they'd pay for regardless?**

Ask both, then build to that answer. This is the operational near-term target everything else should ladder up to. Independent post-call research (§12) explicitly endorsed exactly this SMART goal.
...
## 10. Pending high-value intro — Titi

- The founder's mother is connecting him to **Titi** (intro via WhatsApp the evening of the call; **founder to set the time**).
- Titi runs **quant / decision investing for high-net-worth individuals in Nigeria.** Described as **one of the founder's strongest network nodes — "one of your moats."**
- She had **previously offered a 1–2 week intern slot** — this is the **first concrete summer-internship lead**, and a direct route to the §7 deep-integration wedge.
- **Near-term gate:** locking **≥1 internship by end of May.**

---

## 11. Relationship status with Roy

- First (free) intro call: done (~2026-05-16).
- Roy is **explicitly open to an ongoing relationship** / "keeping him on board further down the line." A paid or ongoing advisory engagement is the implied next stage — **not now.**
- He is a live node in the connection-leverage motion: reach for him on GTM strategy, moat/distribution thinking, early-customer validation, fundraise readiness, and warm-intro paths into US/global VCs and enterprise buyers.

---

## 12. What happened after the call (follow-through)
...
## 13. Action items & open questions

**Near-term actions:**

- [ ] **Set the Titi call time** (mom is bridging via WhatsApp) — founder owns scheduling.
- [ ] **Lock ≥1 summer internship by end of May** (Titi's 1–2 week slot is the live lead; this is the gate to the §7 deep-integration wedge).
- [ ] Run the **2-question discovery framework** (§8) with every early user; drive toward the ≥5-users-with-measurable-ROI + case-study SMART goal by ~July.
- [ ] Trademark the R²F session — **after release**, ~£200, UK/global mark (parked, not now).
- [ ] Keep the **vet-inbound + parent-in-the-loop** posture on any speaking/VC invitation.
...
## Appendix — the mom-requested advisor rundown (PENDING, do not fabricate)

The founder wants (mom-requested, founder agreed) a **"rundown of everyone spoken to so far,"** presented like a podcast synthesis, with **two columns: similarities vs. differences** in the advice each person gave.

**Roster (incomplete — confirm with the founder before producing this):** at least Mr. Reiner, Mr. Gabe (Megasuto), Roy Eitan, Titi (pending), "Mr. Cheese", and the behavioural-neuroscience panelist.

> **Discipline:** Do **NOT** fabricate or guess the complete roster. Confirm the full list with the founder first, and flag inferred vs. sourced per the deep-research standard, before producing the rundown. This appendix is a placeholder for that separate deliverable, not the deliverable itself.

---

## Sourcing note

This document is a faithful synthesis of contemporaneous records of the 2026-05-16 call and its immediate follow-through. It is not a transcript. Roy's framing in §3 and §6–7 is his stated position as recorded; the SMART goal (§8) and IP posture (§9) are the founder's commitments made on/around the call; §12 is post-call work the call triggered. Where the roster or any figure is uncertain it is flagged as such rather than asserted.
</content>
</invoke>
