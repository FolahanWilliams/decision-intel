# Decision Intel GTM v3.4 — DRAFT

**Status:** DRAFT (2026-05-04). Pending NotebookLM cross-source synthesis + 11-call verification gate before lock.
**Supersedes:** v3.3 (`docs/gtm-plan-v3-3-2026-05-01.md`)
**Source of inputs:** three independent Gemini Deep Research reports (Pass 1 blind, Pass 2 with moat stack named, Pass 3 third independent run) added to master KB `809f5104` on 2026-05-04.
...
## §1 What hardens (3-for-3 across all reports — treat as primary-source-grade)

1. **The category claim survives.** "The reasoning audit platform" is the right H1. Stripe-grade category-ownership move. Locked H1 from 2026-05-04 stays untouched.
2. **The ceiling persona survives.** F500 / FTSE 250 / S&P 500 Heads of Corporate Development + GPs at £1B+ AUM funds. Mr. Reiner network points at the US enterprise side; Mr. Gabe network points at the UK side via investor relationships.
3. **The thesis is structurally sound.** Concentration of high-stakes human judgment as agents automate execution. Report 3 adds the cognitive-apprenticeship collapse (50% of senior leaders say AI would have prevented them developing their current skill sets; 39% report cutting junior roles) as an additional tailwind v3.3 didn't capture.
4. **Low-validity domains are where audit value lives.** M&A (70-90% failure rates), VC, market entry, board strategy, judicial sentencing. High-validity domains (medical diagnosis, military tactical) are already algorithmically governed.
5. **Individual founders / fractional advisors / mid-market C-Suite without M&A budget are unviable for venture-scale returns.** 3-for-3 rejection. Confirms the v3.3 disqualified list.
6. **Cultural resistance among elite decision-makers is the sharpest objection.** Verbatim from Report 3: "they don't buy software that governs their own brains." Forces an external-mandate framing, not internal-critique. Single most actionable objection-handling insight across the three reports.
7. **Regulatory tailwinds are the strongest pull mechanism.** EU AI Act Art 14 (Aug 2026) + Basel III ICAAP + SEC AI disclosures + Colorado SB24-205 + GDPR Art 22 + 14 other regimes generate contractual pull through the GC / Audit Committee / CRO triumvirate.

---

## §2 What breaks (the v3.3 → v3.4 amendments)

### Amendment 1: WEDGE CHANGE — Individual £249/mo → Mid-market Strategy £2,499/mo
...
- Word-of-mouth scale via Mr. Reiner principle
...
- 1+ portfolio expansion (Mid-market customer refers DI to a portfolio company or peer firm CSO)

**Kill criterion:** if the graduation rule doesn't fire by month 6 OR Mid-market buyers report the Strategy tier is too constrained for the volume of memos they need DI to govern → re-question whether the wedge should be £4,999/mo Strategy+ tier OR direct enterprise without a wedge.

### Amendment 2: BUYING-COMMITTEE STRUCTURE — Single-buyer → Four-role committee

The current v3.3 plan implicitly collapses the buying committee into "GC writes the cheque." Report 3's 65% budget-constraint finding (65% of legal departments report budget-blocking new tech) reframes the buying motion. The amendment:
...
- End-user value is the wedge into expansion (deal team analysts who use DI daily become referrals into peer firms)
...
- **Education Room flashcards** — DPR-as-artefact moved up the deck order; reasoning-audit moved to "what produces the artefact"
- **Founder School lessons** (`gtm_8` fund buyer pitch, `gtm_9` Pan-African anchor) — reframed
- **Path-to-100M role-playbooks data** — discovery questions reframed to surface committee/regulatory pull, not internal-critique acceptance
- **Discovery + Tailored-Pitch toolkit** — persona openers reframed
- **Personal Social SSOT archetypes** — the 6 archetypes' canonical hooks reframed (e.g. "Billion-Dollar Autopsy" emphasizes the post-mortem ARTEFACT the IC committee should have had, not the audit they didn't run)
- **Pricing page Strategy tier card** — lead changes from "audit your strategic memos" → "generate the audit-committee-grade evidence record on every high-stakes call"

### Amendment 4: CONNECTION-LEVERAGE COHERENCE
...
### Amendment 5: SHARRAN 1-1-1 FRAMEWORK refresh

ONE traffic source: warm intros from Mr. Reiner + Mr. Gabe networks (LinkedIn becomes secondary, not primary).
ONE conversion mechanism: 20-minute audit on a real strategic / IC memo.
ONE delivery model: **Strategy tier £2,499/mo** subscription with optional Design Foundation pricing (£1,999/mo) for the first 5 founding cohort mid-market customers.

The v3.3 line "self-serve sign-up + Individual £249/mo subscription" is REPLACED by the v3.4 line above. Self-serve stays available as the marketing-funnel product (qualified word-of-mouth lands here), but it's not the primary delivery model.
...
## §3 The verification gate (PRIMARY-RESEARCH REQUIRED before lock)

The v3.4 amendments are based on three Deep Research reports converging on the same finding. That's a strong hypothesis. It's NOT a primary-source plan lock. Three Gemini reports converging on a finding is a strong hypothesis; it's not a plan lock. The wedge amendment is a v3.3 → v3.4 change — primary-research territory, not Gemini-research territory.

**11 calls in 14 days, organized into three sets:**

### Set 1 — 5 Heads of Corp Dev at $500M-$2B scale-ups (Mr. Reiner network)
...
- Q4: "If a tool generated an evidence record your audit committee could rely on for governance signoff, would that come out of your team's budget or compliance's?"
- Q5 (signal test, after Q1-4): Show 60-second WeWork DPR specimen. "What's the first thing you'd want to know?"

**Pass criterion:** 3 of 5 confirm budget = their team OR a procurement path through their budget. Pass = wedge thesis confirmed.

### Set 2 — 3 GPs at £50M-£500M AUM funds (Mr. Gabe network)
...
- Q4 (signal test): Show 60-second Dangote DPR specimen if Pan-African / EM-aware fund, WeWork DPR if not. "What's the first thing you'd want to know?"

**Pass criterion:** 2 of 3 confirm fund use case + at least 1 of 3 confirms willingness to refer to portfolio. Pass = mid-market fund wedge + portfolio-expansion path confirmed.

### Set 3 — 3 GCs at FTSE 250 firms (Mr. Gabe network — investor portfolio companies)
...
**Pass criterion:** 2 of 3 confirm budget is NOT in GC's discretion AND GCs are willing to be the regulatory champion for tooling the business unit buys. Pass = buying-committee shape confirmed.

### What happens after the 11 calls

- **All three sets pass** → lock v3.4 as final. Cascade across product + positioning.
- **Set 1 fails (Heads of Corp Dev don't have budget)** → wedge moves UP to "Head of Corp Dev WITH joint budget unlock from GC/CRO" — slower procurement, requires bundled regulatory champion, possibly higher ACV
- **Set 2 fails (GPs don't refer to portfolio)** → fund wedge stays valid but the mid-market-→F500 portfolio expansion path is broken; ceiling becomes harder to reach
- **Set 3 fails (GCs DO have budget)** → restore v3.3's GC-as-buyer framing
- **Mixed signals** → run 5 more calls before locking. Don't cargo-cult the synthesis.

---

## §4 What stays locked from v3.3 (carried forward unchanged)

- Decision system of record positioning (locked v3.2, carried v3.3, carried v3.4)
- Outcome Gate enforced on Individual + Strategy tiers from day one
...
- Sankore as first design partner / target first reference-grade pilot (in active scoping per v3.3 honesty repair #3)
- 5 candidate seed funds + activation tests (per v3.3 §10 honesty repair #4)
- $30M+ founder cash exit math
- Dual-track funding (bootstrap primary + opportunistic pre-seed at $200K / 10% post-money cap)
- Mr. Gabe customers-before-investors rule (now applied to mid-market buyers, not Individual)
- Hybrid discovery + tailored-pitch motion (v3.3 §7)
...
## §5 Funding strategy implications
...
- 2+ verifiable referrals via DPR / advocacy
- 50+ qualified mid-market waitlist contacts in CRM

**Secondary track (opportunistic pre-seed):** Network access motive becomes SHARPER under v3.4 because the wedge buyer (mid-market Corp Dev / Fund Partners) is exactly the persona-class the pre-seed VC partner's portfolio relationships could compress time-to-customer for. The network-access value of the $200K pre-seed roughly TRIPLES under v3.4 vs v3.3.

---

## §6 What the cascade looks like AFTER lock (do NOT execute until v3.4 LOCKED)
...
- `src/lib/data/competitive-positioning.ts` — refreshed for mid-market positioning
- `src/components/founder-hub/path-to-100m/data/role-playbooks.ts` — 8 personas refreshed for committee shape
- `src/components/founder-hub/path-to-100m/data/investor-metrics.ts` — wedge metric definition changed
- `src/components/founder-hub/path-to-100m/data/silent-objections.ts` — cultural-resistance objection added
- `src/lib/data/founder-school/lessons.ts` — gtm_8 + gtm_9 + new gtm_10 (mid-market wedge)
- `src/components/founder-hub/education/education-room-data.ts` — refreshed flashcards
- `src/components/founder-hub/sparring/sparring-room-data.ts` — buyer personas updated; persona for mid-market Corp Dev added
- `src/lib/data/discovery-pitch-toolkit.ts` — new mid-market persona opener; existing personas shifted to committee shape
- `src/lib/data/personal-social-system-prompt.ts` — 6 archetypes reframed for committee shape
- Pricing page (`src/app/(marketing)/pricing/...`) — Strategy tier becomes the highlighted wedge card; Individual tier de-emphasized
- Marketing pages — landing H1 stays; supporting body copy refreshed for cover-not-critique frame
...
This is a 4-6 hour cascade. Do NOT start until v3.4 is LOCKED via the 11-call verification.

---

## §7 Open questions for NotebookLM cross-source synthesis

Run these queries via the master KB before locking v3.4. Each surfaces a contradiction or convergence the three reports alone can't resolve.

1. **Wedge reconciliation:** does the master KB's prior research (Mr. Reiner advice, Mr. Gabe advice, Sankore brief, External Attack Vectors) support the v3.4 mid-market wedge, or contradict it?
2. **GC role reconciliation:** do the three reports' divergent rankings of GC (Reports 1+2 = #1, Report 3 = #5) reconcile when stress-tested against actual budget-flow primary research in the KB?
3. **Positioning reframe consistency:** does the DPR-leads-narrative reframe contradict any prior locked positioning vocabulary or marketing voice rules?
4. **Top-5 ICP convergence:** across all three reports + the master KB, what's the structurally hardest top-5 ICP ranking by demand-growth × per-decision-stakes × procurement-budget-access × competitive-vacancy × moat-utilization?
5. **Sharpest unsaid objection:** what's the strongest objection the three reports + master KB raise that v3.3 didn't address — and does v3.4 actually address it?

Findings appended to §8 below as they come back.

---

## §8 NotebookLM cross-source synthesis (run 2026-05-04)

Five queries against the master KB (notebook 809f5104). Findings:

### Q1 — Wedge reconciliation: Individual £249 → Mid-market £2,499

**Verdict: SUPPORTED on the kill of Individual £249, CONTRADICTED on the unconditional move to £2,499.** The reports + KB validate that Individual buyers are an economic dead-end ("FLAG: INSUFFICIENT EV. A $22.5M ARR ceiling yields a ~$100M valuation"; "Blocks acquisition by GRC and enterprise risk vendors"). Three structural contradictions surfaced:

- **Word-of-Mouth Boundary Illusion.** Individual users evaluate DI as L&D / HR / coaching tool; F500 GCs evaluate against legacy GRC platforms (MetricStream, Quantexa). Referral from fractional advisor = zero weight with enterprise GC. The bridge doesn't exist.
- **Data Moat Catch-22.** Bias Genome requires Convergence Threshold of **30 closed outcomes per firm** for stable per-org Brier calibration. Individual high-churn segment never accumulates that. The wedge has to use buyers who STAY long enough to close 30+ outcomes.
- **Naked Business validation.** Jason Cohen explicitly: solo founders CAN do enterprise sales — "I was doing five-figure deals while it was just me." The "16-yo solo founder must start at £249" assumption is false.

**But:** the Sankore pricing anchor matters. Sankore Design Foundation pilot is **£1,799–£1,999/mo**, not £2,499. If the cold-prospect wedge price exceeds the deeply-nurtured design partner price, the procurement signal breaks.
...
### Q3 — DPR-leads-narrative reframe consistency

**Verdict: PARTIALLY VALIDATED — the reframe needs to be SEQUENCED, not universal.**
...
### Q4 — Top-5 ICP convergence (across all sources)
...
### Q5 — Sharpest unsaid objection (the load-bearing critique)
...
**The catch-22:** Individual £249 has fast procurement + zero regulatory cover + insufficient deal volume. Mid-market £2,499 has weak regulatory cover + slow procurement + insufficient deal volume. F500 has strong regulatory cover + sufficient deal volume + catastrophic 12+ month procurement.

**The synthesis-confirmed wedge is NARROWER than v3.4 DRAFT proposes.**

---

## §8.5 v3.4 PROPOSED — refinement after NotebookLM synthesis

The v3.4 DRAFT had three load-bearing flaws the synthesis surfaced. Refinements:

### Refinement A — Wedge persona TIGHTER

The wedge is NOT generic "Mid-market Corp Dev OR Fund Partners." It's specifically buyers who satisfy ALL THREE simultaneously:

1. **Regulatory urgency** — the DPR-leads frame creates real procurement pull
...
- **GP at £50M–£500M AUM PE/VC fund WITH active LP-governance pressure** (institutional LPs requiring SFDR / ESG / decision-quality reporting; or sovereign-wealth LP backing; or bank-LP-driven). Has all three:
  ...
  - Deal volume: 4–10 deals/year × 5–7 year hold cycle = 30–50 closed outcomes within 5 years (Convergence Threshold hits at year 3–4)
...
- **Head of Corp Dev at $500M–$2B revenue scale-ups with active multi-acquisition rhythm** (3+ deals/year, multi-year M&A roadmap, divisional P&L authority). Has all three:
  ...
  - Deal volume: 3–5 deals/year × 3-year retention = 10–15 outcomes (slower data accumulation than fund-side; but acceptable)

**Disqualified at the wedge** (revised from v3.4 DRAFT): mid-market C-suite generic (Marginally Viable PMF 3/5, 60-day churn risk), mid-market firms without active deal-flow rhythm, mid-market buyers without LP-governance pressure or active M&A pipeline.

### Refinement B — Wedge price REVISED

**Wedge price: £1,999/mo (Sankore-anchored Design Foundation rate as the STANDARD wedge price, not just for the first 5 founding cohort customers).** Reasons:

1. **Procurement-floor preservation.** £1,999 keeps personal-card-equivalent budget feasible; £2,499 doesn't reliably.
2. **Sankore-anchored credibility.** Cold prospects can't pay MORE than the deeply-nurtured design partner. The Design Foundation rate becomes the wedge floor.
3. **Founding cohort discount becomes "first 5 get founding-equity terms"** instead of a price discount — preserves the cohort signal without a pricing distortion.
4. **Strategy tier at £2,499/mo (the v3.3 retail price) becomes the EXPANSION tier** — first hire on the deal team, first cohort partner needs a seat, first bigger deal forces upgrade.
...
- Founder School lessons (gtm_8, gtm_9, new gtm_10)
- Path-to-100M role-playbooks data
- Pricing page Strategy tier card
- DPR specimen leave-behinds and follow-up artefacts

The H1 + immediate body stay untouched — they already do the right work ("...before the committee does" is cover-frame at the H1 level).

### Refinement D — Verification gate REVISED
...
**Pass criteria revised:** Set 1 passes if 3 of 5 confirm budget AND active-acquirer signal AND audit-committee pressure. Set 2 passes if 2 of 3 confirm LP-governance pressure AND personal-decisive budget AND willingness to pay £1,999/mo.

### Refinement E — The Sankore implication

Sankore IS the v3.4 PROPOSED wedge persona. The v3.4 plan should be tested against Sankore as the canonical reference: if every refinement above checks out against the Sankore brief, the plan is bulletproof. If any refinement contradicts what Sankore actually wanted / paid / used, the plan is wrong.

This means: **before any cascade ships, I should re-read the Sankore brief and stress-test v3.4 PROPOSED against it section-by-section.** That's a separate task before lock.

---

## §9 Lock timeline (revised)

- 2026-05-04: v3.4 DRAFT written
- 2026-05-04: NotebookLM synthesis complete (this document, §8 + §8.5)
- 2026-05-05: Stress-test v3.4 PROPOSED against Sankore brief section-by-section (1-2 hour task)
- 2026-05-06 → 2026-05-19: 11-call verification gate (Mr. Reiner asks for Set 1, Mr. Gabe asks for Sets 2 + 3)
...
- 2026-05-04: v3.4 DRAFT written (this document)
- 2026-05-04: NotebookLM synthesis run + appended to §8
- 2026-05-05 → 2026-05-18: 11-call verification gate (Mr. Reiner asks for Set 1, Mr. Gabe asks for Sets 2 + 3)
- 2026-05-19: v3.4 LOCK decision based on call signal
- 2026-05-19 → 2026-05-23: cascade across product + positioning (4-6 hour shipment)
- 2026-05-24: v3.4 published as canonical GTM plan; master KB updated; CLAUDE.md refreshed; investor narrative refreshed
